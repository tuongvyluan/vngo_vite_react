...
const RestaurantsList = () => {
    ...
    useEffect(() => {
        ...
        getAttractions('restaurants', coordinates.lat, coordinates.lng, { limit: 30, min_rating: 4 }, source)
            .then(data => {
                            ...
                            restaurants?.map((restaurant, i) => (
                                <div key={i} className="grid grid-cols-12 my-2 border border-gray-200 rounded shadow hover:shadow-xl cursor-pointer">
                                    ...
                                    <div className="col-span-12 md:col-span-4 h-[180px]">
                                        {/* Link that routes to the placeDetails route with the current restaurant 'locationId' passed into the url parameter */}
                                        <Link to={`restaurants/${restaurant?.locationId}`}>
