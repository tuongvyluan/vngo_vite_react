				...
				<>
					...
					<div className="container mx-auto px-4 pb-4">
						...
						<div className="md:grid grid-cols-1 md:grid-cols-6 gap-3 pb-10">
							...
							{(place?.awards?.length > 0 ||
								...
								<div className="grid grid-cols-6 gap-3 col-span-6">
									<div className="col-span-6 bg-white my-1 mx-0 space-y-3 md:space-y-4">
										<h2 className="font-medium text-2xl">Ratings & Recognitions</h2>
							...
							{/* Place Reviews */}
							<div className="md:col-span-6 bg-white my-1 mx-0">
								{/* Review Count Display */}
								<h2 className="font-medium text-2xl">
									Reviews{' '}
									<span className="text-gray-400">({place?.num_reviews})</span>
								</h2>
								{/* --- */}
