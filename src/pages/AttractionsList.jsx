...
const AttractionsList = () => {
	...
	useEffect(async () => {
		...
		const data = await getAttractions(source)
		...
		<>
			...
			<div className="container mx-auto pb-4">
				<div className="text-center my-10">
					<h1 className="font-semibold text-lg md:text-3xl">Attractions</h1>
				</div>
							...
							{attractions?.map((attraction, i) => (
								<div key={i} className="md:col-span-6 lg:col-span-4 mb-4">
									<div className="w-full h-[250px] md:h-[400px] object-cover">
										{/* Link that routes to the placeDetails route with the current attraction 'locationId' passed into the url parameter */}
										<Link to={`/attractions/${attraction?.locationId}`}>
