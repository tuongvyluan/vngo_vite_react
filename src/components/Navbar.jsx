      ...
      >
        ...
        <Link to={"/"}>
          <img
            src={logo}
            alt="VietnamGo"
            className="h-[36px] sm:h-[36px] md:h-[36px]"
          />
        </Link>
        {/*  */}
        <div className="navbar-left  flex justify-between items-center">
          ...
          {/* --- */}
          {isLogin ? (
            <div className="user-login flex justify-items-center items-center hover:bg-gray-200 py-2 px-4 cursor-pointer rounded-full">
            ...
            <Link to={"/login"}>
              <div className="btn-login rounded-full hover:bg-gray-200 py-2 px-3 cursor-pointer">
                <h1>Login</h1>
              </div>
            </Link>
          )}
